    ...
    <div class="containData">
        ...
        <section class="sectionColumns">
            <v-col cols="6" class="variables">
                <p>Mass</p>
                <input type="number" placeholder="Mass" @change="(e)=>{setMass(e.target.value)}">
                <p>Acceleration</p>
                <input type="number" placeholder="Top speed in m/s" @change="(e)=>{setAcceleration(e.target.value)}">
            </v-col>
            <v-col cols="6">
                <p>Force value</p>
                <h3>{{force}}</h3>
                <button @click="calculateForce"
